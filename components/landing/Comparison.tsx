      ...
      <div className="mx-auto max-w-6xl px-6 py-24 sm:py-32">
        ...
        <Reveal>
          <div className="mt-14 overflow-hidden rounded-2xl border border-gray-200 bg-white">
            <div className="grid grid-cols-3 border-b border-gray-200 bg-gray-50/70 px-6 py-4 text-xs font-medium uppercase tracking-[0.16em] text-gray-500">
              <div></div>
              <div>Traditional sourcing</div>
              <div className="text-gray-900">Nexcierge</div>
            </div>
              ...
              {COMPARISON_ROWS.map((row) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-2 text-gray-500">
                    <Minus className="mt-0.5 h-4 w-4 shrink-0 text-gray-300" strokeWidth={1.5} />
                    <span>{row.traditional}</span>
                  </div>
                  <div className="flex items-start gap-2 text-gray-900">
                    <Check className="mt-0.5 h-4 w-4 shrink-0 text-[#0F2747]" strokeWidth={2} />
