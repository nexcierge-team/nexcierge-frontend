    ...
    <footer className="border-t border-zinc-200 bg-white">
      <div className="mx-auto grid max-w-6xl gap-12 px-6 py-16 md:grid-cols-[2fr_1fr_1fr_1fr]">
        <div className="max-w-sm">
          <div className="font-semibold tracking-[0.16em] text-[15px] text-zinc-900">
            NEXCIERGE
          </div>
      ...
      <div className="border-t border-zinc-200">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-3 px-6 py-6 text-xs text-zinc-400 md:flex-row md:items-center">
