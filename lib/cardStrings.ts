...
const gu: CardStrings = {
  eyebrow: "સોર્સિંગ બ્રીફ",
  title: "અમારા એકાઉન્ટ મેનેજર માટે તૈયાર",
  sectionBuyer: "ખરીદદાર",
  sectionMachine: "મશીન",
  sectionDelivery: "ડિલિવરી",
  sectionSpecs: "સ્પષ્ટીકરણો અને અનુપાલન",
  sectionNotes: "વધારાની નોંધો",
  labelName: "નામ",
  labelCompany: "કંપની",
  labelEmail: "ઇમેઇલ",
  labelPhone: "ફોન",
  labelRole: "ભૂમિકા",
  labelType: "પ્રકાર",
  labelApplication: "ઉપયોગ",
  labelQuantity: "જથ્થો",
  labelNewUsed: "નવું / જૂનું",
  labelCountry: "દેશ",
  ...
  timeline: {
    ...
    "1_to_3_months": "1–3 મહિના",
    "3_to_6_months": "3–6 મહિના",
    just_researching: "માત્ર માહિતી લઈ રહ્યા છીએ",
  },
  condition: {
    new: "નવું",
    used: "જૂનું",
    refurbished: "રિફર્બિશ્ડ",
    no_preference: "કોઈ પસંદગી નથી",
  },
  emptySpecs: "હજુ સુધી કોઈ તકનીકી સ્પષ્ટીકરણ નોંધાયું નથી",
  footerNote: "અમારા એકાઉન્ટ મેનેજર 24 કલાકની અંદર તમારો સંપર્ક કરશે.",
  cta: "માનવ સમીક્ષાની વિનંતી કરો",
  sending: "મોકલાઈ રહ્યું છે…",
  transferred: "ટ્રાન્સફર થયું",
  editHint: "કંઈક બદલવું છે? બસ એજન્ટને કહો.",
};

const ta: CardStrings = {
  eyebrow: "சோர்சிங் சுருக்கம்",
  title: "எங்கள் கணக்கு மேலாளருக்குத் தயார்",
  sectionBuyer: "வாங்குபவர்",
  sectionMachine: "இயந்திரம்",
  sectionDelivery: "விநியோகம்",
  sectionSpecs: "விவரக்குறிப்புகள் & இணக்கம்",
  sectionNotes: "கூடுதல் குறிப்புகள்",
  labelName: "பெயர்",
  labelCompany: "நிறுவனம்",
  labelEmail: "மின்னஞ்சல்",
  labelPhone: "தொலைபேசி",
  labelRole: "பதவி",
  labelType: "வகை",
  labelApplication: "பயன்பாடு",
  labelQuantity: "எண்ணிக்கை",
  labelNewUsed: "புதியது / பயன்படுத்தியது",
  labelCountry: "நாடு",
  ...
  timeline: {
    ...
    "1_to_3_months": "1–3 மாதங்கள்",
    "3_to_6_months": "3–6 மாதங்கள்",
    just_researching: "தகவல் மட்டும் பார்க்கிறேன்",
  },
  condition: {
    new: "புதியது",
    used: "பயன்படுத்தியது",
  ...
  emptySpecs: "இன்னும் தொழில்நுட்ப விவரக்குறிப்புகள் பதிவு செய்யப்படவில்லை",
  footerNote:
    "எங்கள் கணக்கு மேலாளர் 24 மணி நேரத்திற்குள் உங்களைத் தொடர்பு கொள்வார்.",
  cta: "மனித மதிப்பாய்வு கோரவும்",
  sending: "அனுப்பப்படுகிறது…",
  transferred: "மாற்றப்பட்டது",
  editHint: "ஏதேனும் மாற்ற வேண்டுமா? எஜென்ட்டிடம் சொல்லுங்கள்.",
};

const bn: CardStrings = {
  eyebrow: "সোর্সিং ব্রিফ",
  title: "আমাদের অ্যাকাউন্ট ম্যানেজারের জন্য প্রস্তুত",
  sectionBuyer: "ক্রেতা",
  sectionMachine: "মেশিন",
  sectionDelivery: "ডেলিভারি",
  sectionSpecs: "স্পেসিফিকেশন ও কমপ্লায়েন্স",
  sectionNotes: "অতিরিক্ত নোট",
  labelName: "নাম",
  labelCompany: "কোম্পানি",
  labelEmail: "ইমেইল",
  labelPhone: "ফোন",
  labelRole: "পদবি",
  labelType: "ধরন",
  labelApplication: "ব্যবহার",
  labelQuantity: "পরিমাণ",
  labelNewUsed: "নতুন / পুরাতন",
  labelCountry: "দেশ",
  ...
  timeline: {
    ...
    "1_to_3_months": "1–3 মাস",
    "3_to_6_months": "3–6 মাস",
    just_researching: "শুধু খোঁজখবর নিচ্ছি",
  },
  condition: {
    new: "নতুন",
    used: "পুরাতন",
  ...
  emptySpecs: "এখনও কোনো প্রযুক্তিগত স্পেসিফিকেশন নথিভুক্ত হয়নি",
  footerNote:
    "আমাদের অ্যাকাউন্ট ম্যানেজার 24 ঘণ্টার মধ্যে আপনার সঙ্গে যোগাযোগ করবেন।",
  cta: "মানব পর্যালোচনার অনুরোধ করুন",
  sending: "পাঠানো হচ্ছে…",
  transferred: "স্থানান্তরিত",
  editHint: "কিছু বদলাতে চান? শুধু এজেন্টকে বলুন।",
};

const tr: CardStrings = {
  eyebrow: "Tedarik özeti",
  title: "Müşteri temsilcimiz için hazır",
  sectionBuyer: "Alıcı",
  sectionMachine: "Makine",
  sectionDelivery: "Teslimat",
  sectionSpecs: "Özellikler ve uyumluluk",
  ...
  labelRole: "Görev",
  labelType: "Tür",
  labelApplication: "Kullanım amacı",
  labelQuantity: "Adet",
  labelNewUsed: "Yeni / kullanılmış",
  labelCountry: "Ülke",
  ...
  timeline: {
    ...
    "1_to_3_months": "1–3 ay",
    "3_to_6_months": "3–6 ay",
    just_researching: "Sadece araştırıyorum",
  },
  condition: {
    new: "Yeni",
    used: "Kullanılmış",
  ...
  emptySpecs: "Henüz teknik özellik kaydedilmedi",
  footerNote: "Müşteri temsilcimiz 24 saat içinde size dönüş yapacak.",
  cta: "İnsan incelemesi iste",
  sending: "Gönderiliyor…",
  transferred: "Aktarıldı",
  editHint: "Bir şeyi değiştirmek mi istiyorsunuz? Asistana söylemeniz yeterli.",
};

const id: CardStrings = {
  eyebrow: "Ringkasan pengadaan",
  title: "Siap untuk manajer akun kami",
  sectionBuyer: "Pembeli",
  sectionMachine: "Mesin",
  sectionDelivery: "Pengiriman",
  sectionSpecs: "Spesifikasi & kepatuhan",
  ...
  labelRole: "Jabatan",
  labelType: "Jenis",
  labelApplication: "Penggunaan",
  labelQuantity: "Jumlah",
  labelNewUsed: "Baru / bekas",
  labelCountry: "Negara",
  ...
  timeline: {
    ...
    "1_to_3_months": "1–3 bulan",
    "3_to_6_months": "3–6 bulan",
    just_researching: "Baru mencari informasi",
  },
  condition: {
    new: "Baru",
    used: "Bekas",
  ...
  emptySpecs: "Belum ada spesifikasi teknis yang tercatat",
  footerNote: "Manajer akun kami akan menghubungi Anda dalam 24 jam.",
  cta: "Minta tinjauan manusia",
  sending: "Mengirim…",
  transferred: "Dialihkan",
  editHint: "Perlu mengubah sesuatu? Cukup beri tahu agen.",
};

const vi: CardStrings = {
  eyebrow: "Bản tóm tắt tìm nguồn hàng",
  title: "Sẵn sàng cho quản lý tài khoản của chúng tôi",
  sectionBuyer: "Người mua",
  sectionMachine: "Máy móc",
  sectionDelivery: "Giao hàng",
  sectionSpecs: "Thông số & tuân thủ",
  ...
  labelRole: "Chức vụ",
  labelType: "Loại",
  labelApplication: "Ứng dụng",
  labelQuantity: "Số lượng",
  labelNewUsed: "Mới / đã qua sử dụng",
  ...
  timeline: {
    ...
    just_researching: "Chỉ đang tìm hiểu",
  },
  condition: {
    new: "Mới",
    used: "Đã qua sử dụng",
  ...
  emptySpecs: "Chưa ghi nhận thông số kỹ thuật nào",
  footerNote:
    "Quản lý tài khoản của chúng tôi sẽ liên hệ với bạn trong vòng 24 giờ.",
  cta: "Yêu cầu nhân viên xem xét",
  sending: "Đang gửi…",
  transferred: "Đã chuyển",
  editHint: "Cần thay đổi gì? Chỉ cần nói với trợ lý.",
};
