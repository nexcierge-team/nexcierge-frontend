          ...
          <div className="mx-auto max-w-6xl px-6 pt-20 pb-24 sm:pt-28">
            <Reveal>
              <div className="max-w-2xl">
                ...
                <h1 className="mt-3 text-4xl font-semibold tracking-[-0.02em] text-zinc-900 sm:text-5xl">
                  Talk to the team.
                </h1>
            ...
            <div className="mt-14 grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:gap-16">
              <Reveal delay={0.05}>
                <form
                  onSubmit={onSubmit}
                  className="rounded-3xl border border-zinc-200 bg-white p-7 shadow-[0_1px_2px_rgba(0,0,0,0.03)] sm:p-9"
                >
                  {submitted ? (
                    <div className="flex flex-col items-center justify-center py-10 text-center">
                      <CheckCircle2
                        className="h-7 w-7 text-[#0066cc]"
                        strokeWidth={1.5}
                      />
                      ...
                      {CHANNELS.map((c) => (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-1 whitespace-pre-line text-sm text-zinc-900">
                              {c.href ? (
                                <a
                                  href={c.href}
